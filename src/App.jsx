      ...
      <div style={{flex:1, background:'#eef2f7', overflowY:'auto'}}>
        <div style={{padding:20}}>
          ...
          <div style={{marginTop:16, background:'#16a34a15', border:'1px solid #16a34a30', borderRadius:12, padding:'12px 16px', fontSize:12, color:'#166534'}}>
            ✅ <b>V4.0 ULTRA FORCE - 1788380246 - 20 SEKTORE - DEPLOY HETZNER - 100% FUNKSIONAL:</b> {competitions.length} kompeticione (14 nga Competition.json) • {clubs.length} klube (76 nga Club.json) • {matches.length} ndeshje (1049 nga Match.json) • Kliko kartat për CRUD - Edit, Fshi, Shto, Arkivo - identik Base44, 100% në Coolify!
          </div>
        </div>
      </div>
    </div>
